...
public class Bungalow extends Casa {
    ...
    //CONSTRUCTOR
    public Bungalow(String nom, String idAllotjament, Mida mida, int habitacions, int placesPersones, int placesParquing, boolean terrassa, boolean tv, boolean aireFred) {
